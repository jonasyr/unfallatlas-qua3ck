...
- `docs/course-material/` — lecture notes used as AI context: `001_Overview_Data_Analytics_and_Big_Data.md` through `007_Support_Vector_Machines.md` (adopted from a friend's better-structured equivalents on 2026-07-21 — TOC + glossary + source-validation section in each), plus `Master Data Analysis with ChatGPT.md` (no equivalent existed, kept unchanged).
